...
const validationSchema = Yup.object().shape({
    ...
    lang: Yup.string(),
    syncData: Yup.bool(),
    storeLogo: Yup.string().required('Store Logo Required'),
    identifier: Yup.string().required('Identifier Required'),
    address: Yup.string().required('Address Required'),
    township: Yup.string().required('Township Required'),
    availableMoney: Yup.number().required('Available Money Required'),
